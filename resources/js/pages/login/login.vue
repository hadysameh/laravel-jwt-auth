<template>
  ...
  <div class="grid align__item">
    ...
    <div class="register">
      ...
      <form action=""  @submit.prevent="onLogIn" method="" class="form">
        ...
        <div class="form__field" v-if="error">
          <p style="color:#fff">email or password are not correct please try again</p>
        </div>
      ...
      <p>Don't have an accout? <router-link :to="{ name: 'register' }" class="nav-link" active-class="active">sign up</router-link></p>
